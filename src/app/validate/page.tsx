...
export default function Validate() {
  ...
  return (
    <PageShell title="Validate Corrections" showBack>
      {isLoading ? (
        ...
        <div className="empty-state" style={{ minHeight: '60dvh', justifyContent: 'center' }}>
          ...
          <p className="text-sm" style={{ fontWeight: 600 }}>No pending corrections</p>
          <p className="text-xs text-sand">All caught up!</p>
        </div>
      ) : (
