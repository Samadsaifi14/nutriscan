...
export async function POST(req: NextRequest) {
  try {
    ...
    const unsubscribeAllUrl = createUnsubscribeUrl(userId, 'all', baseUrl)
    const unsubscribeWeeklyUrl = createUnsubscribeUrl(userId, 'weekly', baseUrl)
...
<head>
  ...
  <title>Welcome to NutriScan</title>
</head>
...
<div style="max-width:600px;margin:0 auto;padding:32px 16px;">
  ...
  <div style="text-align:center;margin-bottom:32px;">
    <img src="${baseUrl}/icon-512.png" alt="NutriScan" width="88" height="88" style="border-radius:50%;margin-bottom:16px;" />
    <h1 style="font-size:32px;font-weight:900;margin:0 0 4px;color:#2C1F0F;">NutriScan</h1>
  ...
  <div style="background:white;border-radius:24px;padding:40px;box-shadow:0 4px 32px rgba(0,0,0,0.06);margin-bottom:20px;">
    ...
    <p style="font-size:15px;color:#374151;line-height:1.8;margin:0 0 20px;">
      ...
      the food you eat every single day. At NutriScan, we believe that
    ...
    <!-- Our Mission -->
    <h3 style="font-size:17px;font-weight:800;color:#111827;margin:0 0 14px;">🌱 Why We Built NutriScan</h3>
    ...
    <p style="font-size:14px;color:#374151;line-height:1.8;margin:0 0 28px;">
      We built NutriScan with one heartfelt intention — to make food transparency
    ...
    <!-- Features -->
    <h3 style="font-size:17px;font-weight:800;color:#111827;margin:0 0 16px;">✨ What you can do with NutriScan</h3>
  ...
  <div style="background:white;border-radius:20px;padding:20px 24px;box-shadow:0 2px 12px rgba(0,0,0,0.04);text-align:center;">
    ...
    <p style="font-size:12px;color:#9ca3af;margin:0 0 16px;">NutriScan — Scan. Understand. Choose better.</p>
