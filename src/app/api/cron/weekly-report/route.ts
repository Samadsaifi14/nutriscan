    ...
    try {
      ...
      const res = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          to: [user.email],
          subject: `${firstName}, here is your weekly NutriScan nutrition report 📊`,
          html,
        })
      })
...
<head>
  ...
  <title>NutriScan Weekly Report</title>
</head>
...
<div style="max-width:600px;margin:0 auto;padding:32px 16px;">
  ...
  <div style="text-align:center;margin-bottom:28px;">
    <img src="${data.baseUrl}/icon-512.png" alt="NutriScan" width="80" height="80" style="border-radius:50%;margin-bottom:12px;" />
    <h1 style="font-size:28px;font-weight:900;margin:0 0 4px;color:#2C1F0F;">NutriScan</h1>
